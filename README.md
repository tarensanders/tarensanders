...
<!-- SCHOLAR:START -->
[![Publications](https://img.shields.io/badge/Publications-80-1F3A93)](https://scholar.google.com.au/citations?user=8KNzhS4AAAAJ) [![Citations](https://img.shields.io/badge/Citations-14447-1F3A93)](https://scholar.google.com.au/citations?user=8KNzhS4AAAAJ) [![h-index](https://img.shields.io/badge/h--index-33-1F3A93)](https://scholar.google.com.au/citations?user=8KNzhS4AAAAJ) [![i10-index](https://img.shields.io/badge/i10--index-45-1F3A93)](https://scholar.google.com.au/citations?user=8KNzhS4AAAAJ)
<!-- SCHOLAR:END -->
...
**Measurement** — making movement and screen exposure quantifiable
...
**Synthesis** — turning a literature into evidence

| Project | What it does |
| --- | --- |
| [**screen_umbrella**](https://github.com/Motivation-and-Behaviour/screen_umbrella) | Umbrella review of the evidence on children's and adolescents' screen use ([protocol](https://osf.io/3ubqp/)). |
...
`R` · `Python` · `Stata` · `Julia` · `targets` / `renv` · `Quarto` · `Docker` · multilevel modelling · meta-analysis · machine learning
